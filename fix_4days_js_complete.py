...
js_content = """document.addEventListener('DOMContentLoaded', () => {
    ...
    const els = {
        ...
        shortDesc: document.getElementById('display-short-desc'),
        highlight: document.getElementById('display-highlight'),
        itinerary: document.getElementById('itinerary-timeline-box'),
        inclusions: document.getElementById('display-inclusions'),
        exclusions: document.getElementById('display-exclusions')
    };
    ...
    function renderTour() {
        ...
        if(els.highlight) els.highlight.textContent = tourData.highlight;
