document.addEventListener('DOMContentLoaded', () => {
    // Delhi Spiritual & Temple Tour Database
    const tourModes = {
        sedan: {
            duration: "8 Hours",
            cities: "New Delhi",
            ...
            itinerary: [
                { day: "09:00 AM", title: "Breakfast at Godwin Deluxe", desc: "Begin your spiritual journey with a complimentary, hearty breakfast at the Indian Grill Restaurant within Hotel Godwin Deluxe." },
                ...
                { day: "10:30 AM", title: "Gurudwara Bangla Sahib", desc: "Visit the serene Gurudwara Bangla Sahib, one of the most prominent Sikh houses of worship. Experience the peaceful chanting and witness the massive community kitchen (Langar)." },
                { day: "12:30 PM", title: "ISKCON Temple", desc: "Arrive at the beautiful ISKCON Temple dedicated to Lord Krishna. Admire the stunning architecture, intricate woodwork, and the spiritually uplifting atmosphere." },
                { day: "01:30 PM", title: "Lunch Break", desc: "Take a break for lunch at a curated vegetarian restaurant (lunch cost not included)." },
                { day: "02:30 PM", title: "Swaminarayan Akshardham", desc: "Spend the afternoon exploring the magnificent Akshardham Temple complex. Marvel at the breathtaking traditional architecture, gardens, and spiritual exhibitions." },
            ...
            exclusions: [
                "Cost of lunch and beverages consumed during the tour",
                "Personal expenses and tips",
                "Akshardham exhibition tickets (if you choose to view them)"
            ]
        },
        suv: {
            duration: "8 Hours",
    ...
    if (bookingForm) {
        bookingForm.addEventListener('submit', (e) => {
            ...
            fetch(submitUrl, {
                ...
                body: JSON.stringify({
                    _subject: `Grand Holidays - Delhi Spiritual Tour Request`,
                    Name: name,
                    Email: email,
                    Mobile: mobile,
                    Preferred_Date: date,
