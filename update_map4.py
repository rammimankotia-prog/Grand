...
# Replace path
html = html.replace('d="M340,148 L190,318 L438,318 L230,180"', 'd="M340,148 L190,318 L438,318 L440,148"')
...
new_igi_g = """
                        <g>
                            <circle cx="440" cy="148" r="25" fill="rgba(166,124,49,0.1)">
                                <animate attributeName="r" values="12;22;12" dur="2.8s" repeatCount="indefinite"/>
                                <animate attributeName="opacity" values="0.5;0;0.5" dur="2.8s" repeatCount="indefinite"/>
                            </circle>
                            <circle cx="440" cy="148" r="10" fill="#a67c31" stroke="#fff" stroke-width="2.5" filter="url(#pinShadow)"/>
                            <text x="440" y="152" text-anchor="middle" font-family="Playfair Display,serif" font-size="10" font-weight="700" fill="#fff">✈</text>
                            
                            <rect x="395" y="116" width="90" height="24" rx="12" fill="#fff" stroke="#a67c31" stroke-width="2" filter="url(#labelShadow)"/>
                            <text x="440" y="132" text-anchor="middle" font-family="Outfit,sans-serif" font-size="8.5" font-weight="800" fill="#6b4c12" letter-spacing="1">IGI AIRPORT</text>
                            
                            <rect x="390" y="163" width="100" height="18" rx="9" fill="#c59b3f" stroke="#fff" stroke-width="1.5" filter="url(#labelShadow)"/>
                            <text x="440" y="175" text-anchor="middle" font-family="Outfit,sans-serif" font-size="7.5" font-weight="800" fill="#fff" letter-spacing="1">TOUR ENDS</text>

                            <rect x="420" y="184" width="40" height="14" rx="4" fill="#1a1208"/>
                            <text x="440" y="194" text-anchor="middle" font-family="Outfit,sans-serif" font-size="7" font-weight="700" fill="#f0c060">Day 5</text>
                        </g>"""
