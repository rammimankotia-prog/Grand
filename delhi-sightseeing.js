document.addEventListener('DOMContentLoaded', () => {
    ...
    const tourModes = {
        pax2: {
            ...
            price: "$180 Total",
            shortDesc: "Immerse yourself in Delhi's historical heritage at a relaxed, customized pace. Perfect for couples or solo travelers who desire a tailored private tour of Delhi with a premium AC Sedan, a dedicated guide, and flexible itinerary pacing.",
            highlight: "🚗 Includes a private AC Sedan (Maruti Dzire or Toyota Etios), dedicated licensed English-speaking historian guide, traditional rickshaw ride in Chandni Chowk, mineral water, and all toll/parking fees.",
            itinerary: [
                { time: "09:00 AM", title: "Luxury Hotel Pickup", desc: "Your private chauffeur greets you at your Delhi hotel or airport in a premium AC Sedan. Depart for the historic lanes of Old Delhi." },
                ...
                { time: "05:30 PM", title: "Hotel / Airport Drop-off", desc: "Return comfortably in your private Sedan to your hotel or the international airport terminal, concluding your curated tour." }
            ],
            inclusions: [
                "Private AC Sedan (Dzire / Etios) for 8 Hours / 80 Km",
                "Licensed English-speaking professional guide",
                "Yamuna Expressway or city toll taxes, fuel, and parking fees",
        ...
        pax4: {
            ...
            cities: "Old & New Delhi",
            price: "$280 Total",
            shortDesc: "Tailored for families or small groups of friends seeking spacious comfort. Travel together in a premium SUV (Toyota Innova Crysta), accompanied by your personal guide who brings Delhi's centuries of history to life.",
            highlight: "🚘 Includes a premium Toyota Innova Crysta SUV, dedicated licensed English-speaking historian guide, traditional rickshaw ride in Chandni Chowk, onboard refreshments, and all toll/parking fees.",
            itinerary: [
                { time: "09:00 AM", title: "Premium SUV Pickup", desc: "Your chauffeur collects your group of four from your Delhi hotel or airport in a spacious Toyota Innova. Transfer to Old Delhi." },
                ...
                { time: "05:30 PM", title: "Comfortable Return Transfer", desc: "Relax in your spacious SUV as your driver drops you off at your hotel, residence, or airport terminal." }
            ],
            inclusions: [
        ...
        pax6: {
            ...
            cities: "Old & New Delhi",
            price: "$390 Total",
            shortDesc: "Ideal for medium-sized families or corporate groups wishing to explore Delhi together in luxury. Travel in a premium AC Minivan (Tempo Traveller) with high-roof comfort, a personal guide, and customized logistics.",
            highlight: "🚐 Includes a luxury 9/12-Seater AC Tempo Traveller (Minivan), dedicated licensed English-speaking guide, Chandni Chowk rickshaw rides, soft drinks, and all toll/parking fees.",
            itinerary: [
                { time: "09:00 AM", title: "Luxury Minivan Pickup", desc: "Your group is picked up in a luxury AC Tempo Traveller from your hotel or airport. Enjoy the spacious high-roof seating." },
                ...
                { time: "05:30 PM", title: "Minivan Group Drop-off", desc: "Enjoy a comfortable group transfer back to your hotel or airport terminal, concluding your memorable day." }
            ],
            inclusions: [
        ...
        pax10: {
            ...
            cities: "Old & New Delhi",
            price: "$550 Total",
            shortDesc: "Our signature package for larger groups or corporate delegations. Includes a premium AC Mini-Coach, a professional licensed guide, and a dedicated tour logistics coordinator to manage group movement and priority access.",
            highlight: "🚌 Includes a luxury AC Mini-Coach (15-Seater), dedicated English-speaking guide, tour coordinator for seamless logistics, group rickshaw arrangements, and priority parking.",
            itinerary: [
                { time: "09:00 AM", title: "Group Mini-Coach Boarding", desc: "Board your luxury 15-seater AC Mini-Coach. Your tour coordinator welcomes you with cold towels and refreshments." },
                ...
                { time: "05:30 PM", title: "Coordinated Group Drop-off", desc: "Return in your private Mini-Coach to your hotel or Delhi Airport, completing a seamless, high-end heritage journey." }
            ],
            inclusions: [
