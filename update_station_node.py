...
new_svg = """                    <svg viewBox="0 0 680 480" xmlns="http://www.w3.org/2000/svg" class="gt-svg">
                        ...
                        <path id="route-path" d="M500,350 L120,280 L500,350 L580,390" fill="none" stroke="#a67c31" stroke-width="3" stroke-dasharray="10,8" stroke-linecap="round" opacity="0.9">
                        ...
                        <g transform="translate(500, 350)">
                            <rect x="-60" y="-60" width="120" height="20" rx="10" fill="#c59b3f" stroke="#fff" stroke-width="1.5" filter="url(#labelShadow)"/>
                            <text x="0" y="-47" text-anchor="middle" font-family="Outfit,sans-serif" font-size="8.5" font-weight="800" fill="#fff" letter-spacing="1">TOUR STARTS</text>
                            
                            <rect x="-25" y="-37" width="50" height="14" rx="4" fill="#1a1208"/>
                            <text x="0" y="-27" text-anchor="middle" font-family="Outfit,sans-serif" font-size="7" font-weight="700" fill="#f0c060">Day 1</text>
                        </g>
                        ...
                        <!-- RAILWAY STATION (580, 390) -->
                        <g transform="translate(580, 390)">
                            <circle cx="0" cy="0" r="8" fill="#c59b3f" stroke="#fff" stroke-width="2" filter="url(#pinShadow)"/>
                            <text x="0" y="20" text-anchor="middle" font-family="Outfit,sans-serif" font-size="9" font-weight="800" fill="#6b4c12" letter-spacing="0.5">RAILWAY STATION</text>

                            <!-- TOUR ENDS / DROP -->
                            <rect x="-60" y="-65" width="120" height="20" rx="10" fill="#c59b3f" stroke="#fff" stroke-width="1.5" filter="url(#labelShadow)"/>
                            <text x="0" y="-52" text-anchor="middle" font-family="Outfit,sans-serif" font-size="8.5" font-weight="800" fill="#fff" letter-spacing="1">TOUR ENDS</text>
                            
                            <rect x="-25" y="-42" width="50" height="14" rx="4" fill="#1a1208"/>
                            <text x="0" y="-32" text-anchor="middle" font-family="Outfit,sans-serif" font-size="7" font-weight="700" fill="#f0c060">Day 5</text>
                            
                            <rect x="-55" y="-24" width="110" height="14" rx="4" fill="#1a1208" opacity="0.85"/>
                            <text x="0" y="-14" text-anchor="middle" font-family="Outfit,sans-serif" font-size="6.5" font-weight="700" fill="rgba(255,220,120,0.9)">Drop-off Location</text>
                        </g>
